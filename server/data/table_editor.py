...
def add_emojis():
    ...
    PRONOUNS = ['me', 'she', 'it', 'they', 'him', 'her', 'it', 'my', 'mine', 'your', 'yours', 'his', 'her', 'its', 'their', 'who', 'whom', 'whose', 'what', 'which', 'another', 'each', 'everything', 'nobody', 'either', 'someone', 'this', 'myself', 'yourself', 'himself', 'herself', 'itself', 'themselves']
    OTHER_WORDS = ['everything', 'something', 'nothing', 'anything', 'any', 'none']
    PROFANITY = []
